...
namespace ActionFit.Identity.Editor
{
    public static class IdentityPackageMenu
    {
        private const string MenuRoot = "Tools/Package/ActionFit Identity/";
        private const string ReadmePath = "Packages/com.actionfit.identity/README.md";
